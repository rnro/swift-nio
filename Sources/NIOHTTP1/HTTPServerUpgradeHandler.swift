...
public final class HTTPServerUpgradeHandler: ChannelInboundHandler, RemovableChannelHandler {
    ...
    private func handleUpgradeForProtocol(
        ...
        // NIOLoopBound is safe because we never leave the event loop
        let loopBoundContextAndProtocolIterator = NIOLoopBound((context, protocolIterator), eventLoop: context.eventLoop)
